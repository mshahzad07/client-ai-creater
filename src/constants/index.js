export const surpriseMePrompts = [
    ...
    'Generate a landscape with a waterfall',
'Create a portrait of a famous celebrity',
'Generate a cartoon character with a hat',
'Create a cityscape at night',
'Generate a realistic still life with fruit',
'Create a surreal abstract artwork',
'Generate a space scene with planets and stars',
'Create a scene from a fairy tale',
'Generate a pet portrait with a flower crown',
'Create a character illustration for a children book',
'Generate a futuristic cityscape',
'Create a fan art of a popular TV show',
'Generate a fantasy creature with wings',
'Create a beach scene with palm trees',
'Generate a retro poster for a music band',
'Create a logo for a new business',
'Generate a digital painting of a forest',
'Create a vintage postcard from a city',
'Generate an anime-style character',
'Create a still life with books and a candle',
'Generate a winter landscape with snow',
'Create a fashion illustration with a model',
'Generate a character design for a video game',
'Create a food illustration with a recipe',
'Generate a modern abstract artwork',
'Create a sports poster for an event',
'Generate a portrait of a family member',
'Create a Christmas greeting card',
'Generate a futuristic vehicle design',
'Create a horror movie poster',
'Generate a cartoon character with a cape',
'Create a nature illustration with animals',
'Generate a portrait of a historical figure',
'Create a cartoon strip with characters',
'Generate a digital painting of a beach',
'Create a city map with landmarks',
'Generate a portrait of a pet',
'Create a vintage travel poster',
'Generate an underwater scene with fish',
'Create a comic book cover with superheroes',
'Generate a still life with a vase of flowers',
'Create a character design for a board game',
'Generate a landscape with a sunset',
'Create a tattoo design for a client',
'Generate an abstract geometric artwork',
'Create a book cover for a novel',
'Generate a character illustration for a greeting card',
'Create a pet illustration with a funny accessory',
'Generate a movie poster for a romantic comedy',
'Create a portrait of a musician with an instrument'
  ];